  ...
  return (
      <nav className="navbar navbar-light bg-dark-subtle sticky-top py-0">
        <div className="container-fluid ">
          ...
          <img id="mylogo" src={props.mode==='light'?props.lightLogo: props.darkLogo} alt="CaseConverter"  width="160" height="45" className=" py-0 my-0 d-inline-block align-text-top"/>
          </a>
